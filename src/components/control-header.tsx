...
export function ControlHeader() {
  ...
  const toggleWallet = useBotStore((s) => s.toggleWallet);
      ...
      {mode === "live" && (
        ...
        >
          ...
          <span className="font-mono text-xs">
            {walletConnected ? "7xKf…9Uh2" : "Connect wallet"}
          </span>
        </Button>
      )}
      ...
      <AlertDialog open={liveDialog} onOpenChange={setLiveDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Live mode executes real Solana transactions against a curated token
              universe. Losses are irreversible. Paper mode is the recommended default.
            </AlertDialogDescription>
          </AlertDialogHeader>
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              onClick={() => {
                kill();
                toast.error("Positions flattened", {
                  description: "Bot halted.",
                });
              }}
            >
              Kill now
